...
import { d as listThreads, g as useServerFn, i as createThread, o as deleteThread } from "./_ssr/twin.functions-DIQLNhi0.mjs";
import { t as supabase } from "./_ssr/client-D7H0MIue.mjs";
...
import { a as Sparkles, c as Repeat, d as PanelLeft, f as MessageSquare, h as LayoutDashboard, i as Target, l as Plus, n as User, p as LogOut, r as Trash2, t as X } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_authenticated-Bt86ckCg.js
...
function AppSidebar() {
	...
	const removeThread = useMutation({
		mutationFn: (id) => deleteThreadFn({ data: { id } }),
		onSuccess: () => {
			qc.invalidateQueries({ queryKey: ["threads"] });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: "Personal OS"
				})]
			})]
		}) }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarSeparator, {}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: "Modules" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: NAV.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
			asChild: true,
			isActive: isActive(n.to, n.exact),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				to: n.to,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(n.icon, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: n.label })]
			})
		}) }, n.to)) }) })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarMenu, { children: [threadsQ.data?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "px-3 py-2 text-xs text-muted-foreground",
			children: "No conversations yet."
		}), threadsQ.data?.map((t) => {
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "group/thread flex items-center",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
					asChild: true,
					isActive: location.pathname === `/app/chat/${t.id}`,
					className: "flex-1",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/chat/$threadId",
						params: { threadId: t.id },
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "truncate",
							children: t.title
						})]
					})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
			variant: "ghost",
			size: "sm",
...
function AuthenticatedLayout() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "flex h-12 items-center gap-2 border-b px-3 sticky top-0 bg-background/80 backdrop-blur z-10",
